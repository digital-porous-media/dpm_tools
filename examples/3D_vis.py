...
from dpm_tools.io import Image, read_image
...
if __name__ == '__main__':
    ...
    # img = Image('../data/10_01_256_elec.mat')
    img = Image(scalar=file_data['phi'], vector=[file_data['Ix'], file_data['Iy'], file_data['Iz']])
